...
function TPL_html5__smalldb_editor__training_dummy($t, $id, $d, $so)
{
	echo "\t<!-- Smalldb Editor plugin -->\n",
		"\t<link rel=\"stylesheet\" href=\"/plugin/smalldb_editor/external/font-awesome-4.3.0/css/font-awesome.min.css\" type=\"text/css\">\n",
		...
		"\t<script type=\"text/javascript\" src=\"/plugin/smalldb_editor/external/jquery.js\"></script>\n",
		"\t<script type=\"text/javascript\" src=\"/plugin/smalldb_editor/external/gettext.js\"></script>\n",
		"\t<script type=\"text/javascript\" src=\"/plugin/smalldb_editor/external/c2s.js\"></script>\n",
		"\t<script type=\"text/javascript\" src=\"/plugin/smalldb_editor/external/dagre.js\"></script>\n",
